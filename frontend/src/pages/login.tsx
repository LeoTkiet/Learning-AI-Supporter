...
export default function LoginPage() {
  ...
  return (
    <AppLayout maxWidthClass="max-w-md">
      <div className="bg-[#f4f7fb]/95 backdrop-blur-md w-full rounded-2xl shadow-2xl p-8 border border-white/40 animate-fadeIn">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            <input
              ...
              disabled={isLoading}
              className="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e3c72] transition disabled:bg-gray-100 text-sm"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              disabled={isLoading}
              className="w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e3c72] transition disabled:bg-gray-100 text-sm"
            />
            <button
              type="button"
          ...
          <div className="flex justify-end">
            <button
              ...
              className="text-xs text-gray-500 hover:text-[#1e3c72] transition"
            >
              Quên mật khẩu?
            </button>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 mb-4">-- hoặc đăng nhập bằng --</p>
          <div className="flex space-x-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex-1 flex items-center justify-center py-2 px-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition bg-white shadow-sm cursor-pointer disabled:opacity-50 text-xs"
            >
        ...
        <div className="mt-6 text-center text-xs text-gray-600">
          ...
          <Link href={ROUTES.LOGIN} className="font-bold text-[#1e3c72] hover:underline">
            Đăng ký ngay
          </Link>
        </div>
      </div>

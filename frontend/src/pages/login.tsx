        ...
        <div className="bg-[#f4f7fb]/95 backdrop-blur-md w-full max-w-md rounded-2xl shadow-2xl p-8 border border-white/40">
          ...
          <form className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e3c72] transition"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e3c72] transition"
              />
              <button
                type="button"
            ...
            <div className="flex justify-end">
              <a href="#" className="text-sm text-gray-500 hover:text-[#1e3c72] transition">
                Quên mật khẩu?
              </a>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#1e3c72] text-white font-bold py-3 px-4 rounded-lg hover:bg-[#2a5298] transition shadow-lg"
            >
              ĐĂNG NHẬP
            </button>
          </form>
          ...
          <div className="mt-6 text-center">
            ...
            <div className="flex space-x-4">
              ...
              {/* Nút Google */}
              <button className="flex-1 flex items-center justify-center py-2 px-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition bg-white shadow-sm">
